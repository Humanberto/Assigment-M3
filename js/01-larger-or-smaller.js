...
if (num1 === num2) {
    document.write("<p class="response">You entered the same number! <break>Please refresh this page to try again.</p>");
    ...
    document.write(bigNum + " is the larger number. <br>");
}